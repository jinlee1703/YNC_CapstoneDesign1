...
public class MapActivity2 extends AppCompatActivity implements View.OnClickListener, BeaconConsumer, SensorEventListener {
    ...
    //출구 좌표
    private double[] exit_location = {60.0, 0.0};
...
//            float a = (float) exit_angle;
            float azimuthinDegress  = (float) ((int) ( Math.toDegrees( SensorManager.getOrientation( mR, mOrientation)[0] ) + 360 + exit_angle - 120) % 360);
            ...
            float azimuthinDegress_fi  = (float) ((int) ( Math.toDegrees( SensorManager.getOrientation( mR, mOrientation)[0] ) + 360 + fire_angle - 120) % 360);
            ...
            float azimuthinDegress_ex  = (float) ((int) ( Math.toDegrees( SensorManager.getOrientation( mR, mOrientation)[0] ) + 360 + water_angle - 120) % 360);
